...
| Condensatore elettrolitico | 100 µF, 10 V — stabilizzazione rail ESP32 | tra 3.3 V e GND, vicino ai pin VCC/GND dell'ESP32 |
| Condensatori ceramici bypass | 100 nF, 50 V (MLCC "104") — ×5 min | uno in parallelo a ciascun elettrolitico + sui pin VCC dell'ESP32 |
...
- Ventola: per evitare brown-out dell'ESP32 al cambio di velocità, usare un soft-start PWM (rampa graduale) invece di salti diretti al valore target.
